...
from cliboa.scenario.validator import EssentialParameters,IOInput, PostgresTableExistence
...
class PostgresRead(BasePostgres):
    ...
    def execute(self, *args):
        ...
        param_valid = EssentialParameters(self.__class__.__name__, [self._tblname,self._password,self._host,self._dbname])
        param_valid()
